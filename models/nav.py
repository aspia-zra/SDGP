...
class navbar(ctk.CTkFrame):
    ...
    def admin_nav(self):
        ...
        ctk.CTkButton(self.navbar, text="Notifications", **btnConfig).grid(row=2, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, command=self.open_settings, text="Settings", **btnConfig).grid(row=3, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Payments", **btnConfig).grid(row=4, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Complaints", **btnConfig).grid(row=5, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Repairs", **btnConfig).grid(row=6, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, fg_color=theme.PRIMARY, hover_color=theme.DANGER, text="Logout", command=self.logoutbtn).grid(row=8, column=0, padx=20, pady=20, sticky="s")

    def mng_nav(self):
        self._reset_navbar()
        btnConfig = self._nav_button_config()
        ctk.CTkButton(self.navbar, command=self.open_admindash, text="Admin View", **btnConfig).grid(row=1, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, command=self.open_finance_readonly, text="Finance View", **btnConfig).grid(row=2, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, command=self.open_settings, text="Settings", **btnConfig).grid(row=3, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Payments", **btnConfig).grid(row=4, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Complaints", **btnConfig).grid(row=5, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Repairs", **btnConfig).grid(row=6, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, text="Reports", **btnConfig).grid(row=7, column=0, padx=20, pady=20, sticky="ew")
        ctk.CTkButton(self.navbar, fg_color=theme.PRIMARY, hover_color=theme.DANGER, text="Logout", command=self.logoutbtn).grid(row=8, column=0, padx=20, pady=20, sticky="s")
    ...
    def open_finance_readonly(self):
        from gui.finance_view import FinanceView
        self.controller.clear_page()
        self.controller.navbar_mode = "manager"
        self.controller.current_page = FinanceView(self.controller, self.controller)
        self.controller.current_page.grid(row=0, column=0, sticky="nsew")
    ...
    def open_admindash(self):
        from gui.Admindash import admindashboard
        self.controller.clear_page()
        self.controller.current_page = admindashboard(self.controller)
        self.controller.current_page.grid(row=0, column=0, sticky="nsew")
